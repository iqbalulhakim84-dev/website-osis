...
$query = "
SELECT hq.*, da.nama, da.kelas, ak1.nama AS dibuat_oleh, ak2.nama AS diubah_oleh 
FROM hafalan_quran hq
JOIN data_anggota da ON hq.id_anggota = da.id_anggota
LEFT JOIN akun ak1 ON hq.created_by = ak1.id_akun
LEFT JOIN akun ak2 ON hq.updated_by = ak2.id_akun
ORDER BY hq.tanggal DESC
";
$result = mysqli_query($db, $query);

// jika tombol tambah di tekan jalankan script berikut
if (isset($_POST['tambah'])) {
    if (create_hafalan_quran($_POST) > 0) {
        echo "<script>
               alert('Data Berhasil Ditambahkan');
               document.location.href = 's1-hq.php';
               </script>";
    } else {
        echo "<script>
...
if (isset($_POST['ubah'])) {
    if (update_hafalan_quran($_POST) > 0) {
        echo "<script>
...
if (isset($_POST['hapus'])) {
    if (delete_hafalan_quran($_POST) > 0) {
        echo "<script>
...
<div class="content-wrapper">
    <div class="container mt-5 overflow-x-scroll">
        <div class="d-flex justify-content-between align-items-center">
            <h2>Sekbid 1 – Tes Hafalan Quran Juz 30</h2>
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ayat" id="ayat" class="form-control" required>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            <label for="ayat">Ayat</label>
                            <input type="text" name="ayat" id="ayat" class="form-control" value="<?= htmlspecialchars($r['ayat']); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="nilai">Nilai</label>
                            <select name="nilai" id="nilai" class="form-control" required>
